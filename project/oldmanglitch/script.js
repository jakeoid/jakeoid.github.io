function refreshName() {
	...
	document.getElementById('form-error-oldman').innerHTML = "";
	document.getElementById("form-error-oldman").className = "";
	...
	shownname = fixedname.replace("<", "PK").replace(">", "MN");

	newvalue = document.getElementById('fixedname');
	newvalue.innerHTML = shownname;
	...
	if (playername.value.indexOf("Pk") >= 0 || playername.value.indexOf("pK") >= 0 || playername.value.indexOf("PK") >= 0 || playername.value.indexOf("pk") >= 0) {

		document.getElementById('form-error-oldman').innerHTML = "We've noticed you tried to put in P<sup>K</sup>. You should substitute the character < instead if that's what you we're attempting to enter. ";
		document.getElementById("form-error-oldman").className = "error-message";

	} else if (playername.value.indexOf("Mn") >= 0 || playername.value.indexOf("mN") >= 0 || playername.value.indexOf("MN") >= 0 || playername.value.indexOf("mn") >= 0) {

		document.getElementById('form-error-oldman').innerHTML = "We've noticed you tried to put in M<sup>N</sup>. You should substitute the character < instead if that's what you we're attempting to enter. ";
		document.getElementById("form-error-oldman").className = "error-message";
